...
sgs.ai_skill_invoke.jiebiyue = function(self, data)
...
function SmartAI:findLeijiTarget(player, leiji_value, slasher)
	...
	local getCmpValue = function(enemy)
		...
		damage.damage = 2
		if not self:damageIsEffective_(damage) then return 99 end --负的吗？
		if enemy:hasShownSkill("hongyan") or enemy:isRemoved() then return 99 end
